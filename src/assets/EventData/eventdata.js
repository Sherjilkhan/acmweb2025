...
import ce2 from "/assets/Event-data/ce1.jpg";
import ce1 from "/assets/Event-data/ce2.jpg";
import ce3 from "/assets/Event-data/ce3.png";
...
const events = [
  
  {
    ...
    glimpse: [kl1, kl2, kl3],
    short_description:
      "Kleos is a national-level hackathon that challenges innovators to solve real-world problems. Participants compete in teams for a cash pool, gaining hands-on experience in product development. Guided by industry mentors, this event builds essential skills like teamwork, problem-solving, and adaptability while fostering creativity and collaboration.",
    description:
  ...
  },
  {
    ...
    glimpse: [cs1, cs2, cs3],
    short_description:
      "CodeSummit is a thrilling national coding competition designed to test logic, speed, and problem-solving skills. Participants tackle real-time challenges, sharpening their coding fundamentals under pressure. The event helps build resilience and provides an excellent platform for coders to benchmark their abilities against top talent from across the country.",
    description:
  ...
  },
  {
    ...
    glimpse: [gd1, gd2, gd3],
    short_description:
      "GOLD 2025 unites multiple ACM India chapters for a collaborative multi-chapter event. It features expert speaker sessions on investment banking and cybersecurity, alongside an engaging Reverse Coding Competition. This event fosters inter-chapter collaboration, knowledge sharing, and provides a platform for students to test their frontend development skills.",
    description:
  ...
  },
  {
    ...
    endDate: "2026-01-16",
    venue: "Lab 408, RAIT, Nerul",
    type: "Internship Program",
    glimpse: [wip1, wip2, wip3],
    short_description:
      "This program offers students an exclusive internship to transform ideas into impactful projects across domains like Data Science, AR/VR, and Cybersecurity. Guided by industry experts, participants gain hands-on experience and develop technical expertise. The program nurtures problem-solving, teamwork, and project management skills, bridging classroom learning with real-world innovation.",
    description:
  ...
  },
  {
    ...
    endDate: "2025-12-13",
    venue: "Don Bosco High School, Seawoods",
    type: "Social Event",
    glimpse: [hoc1, hoc2, hoc3],
    short_description:
      "Hour of Code is a week-long social initiative introducing young children to the world of computing. Through fun, hands-on activities, participants learn digital literacy basics, including internet navigation and Microsoft Office. This event sparks curiosity, builds confidence with technology, and lays a foundation for future learning in coding.",
    description:
  ...
  },
  {
    ...
    endDate: "2025-10-09",
    venue: "Lab 613, RAIT, Nerul",

    type: "Workshop",
    glimpse: [bb1, bb2, bb3],
    short_description:
      "This workshop introduces students to ethical hacking and vulnerability testing as part of Cybersecurity Awareness Month. Led by an expert speaker, the session features live demonstrations on bug bounty techniques. Participants gain practical skills, learn to identify and report vulnerabilities responsibly, and explore potential career paths in cybersecurity.",
    description:
  ...
  },
  {
    ...
    glimpse: [],
    short_description:
      "This competition encourages students to blend art with technology by designing posters on digital safety and cybersecurity. As part of Cybersecurity Awareness Month, it provides a creative platform to showcase ideas and raise awareness about future tech challenges. The event turns complex cybersecurity concepts into powerful, informative visual messages.",
    description:
  ...
  },
  {
    ...
    endDate: "2025-10-06",
    venue: "Lab 501, RAIT, Nerul",
    type: "Workshop",
    glimpse: [cc1, cc2, cc3],
    short_description:
      "Coded Creativity is a hands-on workshop focused on modern web development. Led by industry experts, participants learn to build responsive websites through practical demonstrations and real-time coding. The session builds a strong technical foundation while fostering problem-solving skills, teamwork, and the ability to translate creative ideas into functional web pages.",
    description:
  ...
  },
  {
    ...
    startDate: "2025-10-05",
    endDate: "2025-10-05",
    venue: "Lab 619, RAIT, Nerul",
    type: "Workshop",
    glimpse: [],
    short_description:
      "This workshop provides a hands-on introduction to the Linux operating system. Guided by Dr. Gautam Borkar, participants learn essential command-line operations, file management, and system basics. The session emphasizes practical application in development, cybersecurity, and cloud computing, empowering attendees with foundational skills for various tech roles.",
    description:
  ...
  },
  {
    ...
    endDate: "2025-09-16",
    venue: "Lab 615, RAIT, Nerul",
    type: "Magazine Launch",
    glimpse: [ky1, ky2, ky3],
    short_description:
      "This event celebrates the launch of KYROS, a student magazine focused on Augmented and Virtual Reality. It brings together students and faculty to explore emerging technology trends and showcase innovation. The launch serves as a platform for knowledge sharing, creative expression, and marks the transition of the RAIT ACM leadership.",
    description:
  ...
  },
  {
    ...
    short_description:
      "This Eminent Speaker Program explores the latest technology trends shaping our world. Led by Dr. R. Venkateswaran, the session delves into emerging innovations with real-world examples and practical insights. It encourages critical thinking and equips students with a broader perspective on the future of the tech industry.",
    description:
  ...
  },
  {
    ...
    endDate: "2025-09-14",
    venue: "Lab 618, RAIT, Nerul",
    type: "Workshop",
    glimpse: [ee1, ee2, ee3],
    short_description:
      "This comprehensive workshop equips participants with foundational engineering skills. The sessions cover Python programming, Data Structures and Algorithms (DSA), version control with Git and GitHub, and professional networking on LinkedIn. It’s designed to provide a strong technical and professional base for aspiring engineers and developers.",
    description:
  ...
  },
  {
    ...
    endDate: "2025-10-30",
    venue: "Lab 308, RAIT, Nerul",
    type: "Workshop",
    glimpse: [vr1, vr2, vr3],
    short_description:
      "This workshop guides participants in creating immersive 3D virtual environments using Unity. Led by experts, the hands-on session covers essential development techniques and includes an Oculus VR experience. It empowers students with the skills to innovate in gaming, simulation, and other applications within the growing field of immersive technologies.",
    description:
  ...
  },
  {
    ...
    glimpse: [ce1, ce2, ce3],
    short_description:
      "This workshop introduces the core principles of digital protection. Led by Dr. Gautam Borkar, participants learn to identify vulnerabilities, understand security protocols, and implement safe computing practices through practical examples. The session builds a strong foundation in cybersecurity essentials, preparing students for today’s digital challenges.",
    description:
